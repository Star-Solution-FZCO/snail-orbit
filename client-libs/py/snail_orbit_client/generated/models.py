...
#   timestamp: 2025-10-30T00:44:06+00:00
...
class AttachmentSourceTypeT(Enum):
    issue = 'issue'
    comment = 'comment'
...
class BatchSuccessItemUUID(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    payload: UUID = Field(..., title='Payload')
...
class IssueAttachmentBatchDeleteBody(BaseModel):
    ...
    attachment_ids: Sequence[UUID] = Field(..., title='Attachment Ids')
    """
...
class IssueListByIdsRequest(BaseModel):
    ...
    ] = Field(..., title='Issue Ids')
    """
    List of issue IDs or aliases to fetch
    """
...
class IssueListTileUpdate(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    name: str | None = Field(default=None, title='Name')
...
class Profile(BaseModel):
    ...
    is_active: bool = Field(..., title='Is Active')
    is_bot: bool = Field(..., title='Is Bot')
...
class ReportTileCreate(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    type: Literal['report'] = Field(default='report', title='Type')
    name: str = Field(..., title='Name')
    """
    Display name of the tile
    """
    ...
    UI-specific settings for the tile
    """
    report_id: constr(pattern=r'^[0-9a-f]{24}$', min_length=24, max_length=24) = Field(
        ..., examples=['5eb7cf5a86d9755df3a6c593'], title='Report Id'
    )
    """
    ID of the report to display in this tile
    """


class ReportTileOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    id: UUID = Field(..., title='Id')
    ...
    UI-specific settings for the tile
    """
    report: ReportLinkOutput
    """
    Report information for this tile
    """


class ReportTileUpdate(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    name: str | None = Field(default=None, title='Name')
    ...
    report_id: (
        constr(pattern=r'^[0-9a-f]{24}$', min_length=24, max_length=24) | None
    ) = Field(default=None, title='Report Id')
    """
    Report ID for report tiles
    """
...
class SprintCustomFieldAvailable(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    type: Literal['sprint'] = Field(default='sprint', title='Type')
    name: str = Field(..., title='Name')
    """
    Field name
    """
...
class SprintCustomFieldParsed(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    type: Literal['sprint'] = Field(default='sprint', title='Type')
...
class SprintMultiCustomFieldAvailable(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    type: Literal['sprint_multi'] = Field(default='sprint_multi', title='Type')
    name: str = Field(..., title='Name')
    """
    Field name
    """
...
class SprintMultiCustomFieldParsed(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    type: Literal['sprint_multi'] = Field(default='sprint_multi', title='Type')
...
class SprintOption(BaseModel):
    ...
    id: str = Field(..., title='Id')
    value: str = Field(..., title='Value')
    is_completed: bool | None = Field(default=False, title='Is Completed')
    is_archived: bool | None = Field(default=False, title='Is Archived')
    color: str | None = Field(default=None, title='Color')
    start_date: datetime | None = Field(default=None, title='Start Date')
    end_date: datetime | None = Field(default=None, title='End Date')
    description: str | None = Field(default=None, title='Description')
...
class SprintOptionCreateBody(BaseModel):
    ...
    is_archived: bool | None = Field(default=False, title='Is Archived')
    color: str | None = Field(default=None, title='Color')
    planed_start_date: date | None = Field(default=None, title='Planed Start Date')
    planed_end_date: date | None = Field(default=None, title='Planed End Date')
    start_date: date | None = Field(default=None, title='Start Date')
    end_date: date | None = Field(default=None, title='End Date')
    description: str | None = Field(default=None, title='Description')
...
class SprintOptionUpdateBody(BaseModel):
    ...
    value: str | None = Field(default=None, title='Value')
    is_completed: bool | None = Field(default=None, title='Is Completed')
    is_archived: bool | None = Field(default=None, title='Is Archived')
    color: str | None = Field(default=None, title='Color')
    planed_start_date: date | None = Field(default=None, title='Planed Start Date')
    planed_end_date: date | None = Field(default=None, title='Planed End Date')
...
class TileOutputRootModel(RootModel[IssueListTileOutput | ReportTileOutput]):
    model_config = ConfigDict(
        frozen=True,
    )
    root: IssueListTileOutput | ReportTileOutput = Field(
        ..., discriminator='type', title='TileOutputRootModel'
    )


class TileUpdateRootModel(RootModel[IssueListTileUpdate | ReportTileUpdate]):
    model_config = ConfigDict(
        frozen=True,
    )
    root: IssueListTileUpdate | ReportTileUpdate = Field(
        ..., discriminator='type', title='TileUpdateRootModel'
    )
...
class UserFieldValueOutput(BaseModel):
    ...
    is_active: bool | None = Field(..., title='Is Active')
...
class BaseListPayloadShortOptionOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    count: int = Field(..., title='Count')
    limit: int = Field(..., title='Limit')
    offset: int = Field(..., title='Offset')
    items: Sequence[ShortOptionOutput] = Field(..., title='Items')
...
class BaseListPayloadUnionUserFieldValueOutputShortOptionOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    count: int = Field(..., title='Count')
    limit: int = Field(..., title='Limit')
    offset: int = Field(..., title='Offset')
    items: Sequence[UserFieldValueOutput | ShortOptionOutput] = Field(
        ..., title='Items'
    )
...
class BatchFailureItemUUID(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    error_code: HTTPStatus
    error_messages: Sequence[str] | None = Field(default=None, title='Error Messages')
    error_fields: Mapping[str, str] | None = Field(default=None, title='Error Fields')
    payload: UUID = Field(..., title='Payload')


class BatchOperationOutputUUIDUUID(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    successes: Sequence[BatchSuccessItemUUID] = Field(..., title='Successes')
    failures: Sequence[BatchFailureItemUUID] = Field(..., title='Failures')
...
class IssueAttachmentBodyInput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    id: UUID = Field(..., title='Id')
...
class IssueAttachmentBodyOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    id: UUID = Field(..., title='Id')
...
class IssueAttachmentWithSourceOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    id: UUID = Field(..., title='Id')
    ...
    """
    Type of source where the attachment is located
    """
    source_id: str | UUID = Field(..., title='Source Id')
    """
    ID of the source (issue ObjectId or comment UUID)
    """
...
class IssuePermissionOutput(BaseModel):
    ...
    is_inherited: bool = Field(..., title='Is Inherited')
    """
    Whether this permission is inherited from project
    """
...
class IssueSprintFieldChangeOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    type: Literal['field'] = Field(default='field', title='Type')
    old_value: SprintOption | None = None
    new_value: SprintOption | None = None
    field_id: str = Field(..., examples=['5eb7cf5a86d9755df3a6c593'], title='Field Id')
    field_gid: str = Field(..., title='Field Gid')
    field_name: str = Field(..., title='Field Name')
    field_type: Literal['sprint'] = Field(default='sprint', title='Field Type')


class IssueSprintMultiFieldChangeOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    type: Literal['field'] = Field(default='field', title='Type')
    old_value: Sequence[SprintOption] | None = Field(..., title='Old Value')
    new_value: Sequence[SprintOption] | None = Field(..., title='New Value')
    field_id: str = Field(..., examples=['5eb7cf5a86d9755df3a6c593'], title='Field Id')
    field_gid: str = Field(..., title='Field Gid')
    field_name: str = Field(..., title='Field Name')
    field_type: Literal['sprint_multi'] = Field(
        default='sprint_multi', title='Field Type'
    )
...
class (
    RootModel[
    ...
    root: (
        ...
        ...,
        discriminator='type',
        title="RootModel[Annotated[Union[StringCustomFieldAvailable, IntegerCustomFieldAvailable, FloatCustomFieldAvailable, BooleanCustomFieldAvailable, DateCustomFieldAvailable, DateTimeCustomFieldAvailable, DurationCustomFieldAvailable, EnumCustomFieldAvailable, EnumMultiCustomFieldAvailable, StateCustomFieldAvailable, VersionCustomFieldAvailable, VersionMultiCustomFieldAvailable, UserCustomFieldAvailable, UserMultiCustomFieldAvailable, OwnedCustomFieldAvailable, OwnedMultiCustomFieldAvailable, SprintCustomFieldAvailable, SprintMultiCustomFieldAvailable, ProjectFieldAvailable, HashtagFieldAvailable, TagFieldAvailable], FieldInfo(annotation=NoneType, required=True, discriminator='type')]]",
    )
...
class SprintCustomFieldGroupWithValuesOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    field: CustomFieldGroupLinkOutput
    ...
    """
    type: Literal['sprint'] = Field(default='sprint', title='Type')
    values: Sequence[SprintOption | None] = Field(..., title='Values')
    """
    Sprint option values
    """


class SprintCustomFieldOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    id: str = Field(..., examples=['5eb7cf5a86d9755df3a6c593'], title='Id')
    ...
    type: Literal['sprint'] = Field(default='sprint', title='Type')
    is_nullable: bool = Field(..., title='Is Nullable')
    default_value: SprintOptionOutput | None = None
    label: str = Field(..., title='Label')
    description: str | None = Field(default=None, title='Description')
    ai_description: str | None = Field(default=None, title='Ai Description')
    projects: Sequence[ProjectShortOutput] = Field(..., title='Projects')
    options: Sequence[SprintOptionOutput] = Field(..., title='Options')


class SprintCustomFieldValueOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    id: str = Field(..., examples=['5eb7cf5a86d9755df3a6c593'], title='Id')
...
class SprintMultiCustomFieldOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    id: str = Field(..., examples=['5eb7cf5a86d9755df3a6c593'], title='Id')
    ...
    type: Literal['sprint_multi'] = Field(default='sprint_multi', title='Type')
    is_nullable: bool = Field(..., title='Is Nullable')
    default_value: Sequence[SprintOptionOutput] | None = Field(
        ..., title='Default Value'
    )
    label: str = Field(..., title='Label')
    description: str | None = Field(default=None, title='Description')
...
class SprintMultiCustomFieldValueOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    id: str = Field(..., examples=['5eb7cf5a86d9755df3a6c593'], title='Id')
    ...
    name: str = Field(..., title='Name')
    type: Literal['sprint_multi'] = Field(default='sprint_multi', title='Type')
    value: Sequence[SprintOption] | None = Field(..., title='Value')
...
class SuccessPayloadOutputIssueAttachmentWithSourceOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    success: bool | None = Field(default=True, title='Success')
    payload: IssueAttachmentWithSourceOutput
...
class SuccessPayloadOutputUserOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    success: bool | None = Field(default=True, title='Success')
...
class BaseListOutputShortOptionOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    success: bool | None = Field(default=True, title='Success')
    payload: BaseListPayloadShortOptionOutput
...
class BaseListOutputUnionUserFieldValueOutputShortOptionOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    success: bool | None = Field(default=True, title='Success')
    payload: BaseListPayloadUnionUserFieldValueOutputShortOptionOutput
...
class BaseListPayloadIssueAttachmentWithSourceOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    count: int = Field(..., title='Count')
    limit: int = Field(..., title='Limit')
    offset: int = Field(..., title='Offset')
    items: Sequence[IssueAttachmentWithSourceOutput] = Field(..., title='Items')
...
class BaseListPayloadUnionEnumOptionOutputUserOutputStateOptionOutputVersionOptionOutputOwnedOptionOutputSprintOptionOutput(
    BaseModel
):
    model_config = ConfigDict(
        frozen=True,
...
class BatchFailureItemIssueAttachmentBody(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    error_code: HTTPStatus
    error_messages: Sequence[str] | None = Field(default=None, title='Error Messages')
    error_fields: Mapping[str, str] | None = Field(default=None, title='Error Fields')
    payload: IssueAttachmentBodyOutput


class BatchSuccessItemIssueAttachmentWithSourceOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    payload: IssueAttachmentWithSourceOutput
...
class IssueAttachmentBatchCreateBody(BaseModel):
    ...
    attachments: Sequence[IssueAttachmentBodyInput] = Field(..., title='Attachments')
    """
...
class IssueCommentCreate(BaseModel):
    ...
    attachments: Sequence[IssueAttachmentBodyInput] | None = Field(
...
class (
    RootModel[
    ...
    root: (
        ...
        ...,
        discriminator='type',
        title="RootModel[Annotated[Union[StringCustomFieldParsed, IntegerCustomFieldParsed, FloatCustomFieldParsed, BooleanCustomFieldParsed, DateCustomFieldParsed, DateTimeCustomFieldParsed, DurationCustomFieldParsed, EnumCustomFieldParsed, EnumMultiCustomFieldParsed, StateCustomFieldParsed, VersionCustomFieldParsed, VersionMultiCustomFieldParsed, UserCustomFieldParsed, UserMultiCustomFieldParsed, OwnedCustomFieldParsed, OwnedMultiCustomFieldParsed, SprintCustomFieldParsed, SprintMultiCustomFieldParsed, ProjectFieldParsed, HashtagFieldParsed, TagFieldParsed], FieldInfo(annotation=NoneType, required=True, discriminator='type')]]",
    )
...
class SprintCustomFieldGroupOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    gid: str = Field(..., title='Gid')
    ...
    description: str | None = Field(default=None, title='Description')
    ai_description: str | None = Field(default=None, title='Ai Description')
    fields: Sequence[SprintCustomFieldOutput] = Field(..., title='Fields')


class SprintMultiCustomFieldGroupOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    gid: str = Field(..., title='Gid')
    ...
    description: str | None = Field(default=None, title='Description')
    ai_description: str | None = Field(default=None, title='Ai Description')
    fields: Sequence[SprintMultiCustomFieldOutput] = Field(..., title='Fields')
...
class BaseListOutputIssueAttachmentWithSourceOutput(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    success: bool | None = Field(default=True, title='Success')
    payload: BaseListPayloadIssueAttachmentWithSourceOutput
...
class BaseListOutputUnionEnumOptionOutputUserOutputStateOptionOutputVersionOptionOutputOwnedOptionOutputSprintOptionOutput(
    BaseModel
):
    model_config = ConfigDict(
        frozen=True,
    ...
    success: bool | None = Field(default=True, title='Success')
    payload: BaseListPayloadUnionEnumOptionOutputUserOutputStateOptionOutputVersionOptionOutputOwnedOptionOutputSprintOptionOutput
...
class BatchOperationOutputIssueAttachmentWithSourceOutputIssueAttachmentBody(BaseModel):
    model_config = ConfigDict(
        frozen=True,
    )
    successes: Sequence[BatchSuccessItemIssueAttachmentWithSourceOutput] = Field(
        ..., title='Successes'
    )
    failures: Sequence[BatchFailureItemIssueAttachmentBody] = Field(
        ..., title='Failures'
    )
    total: int = Field(..., title='Total')
    success_count: int = Field(..., title='Success Count')
...
class QueryBuilderOutput(BaseModel):
    ...
    """
    filters: Sequence[
        
    ] = Field(..., title='Filters')
    """
    Fields currently in query with their values
    """
    available_fields: Sequence[
        
...
class TileUpdate(TileUpdateRootModel):
    """Enhanced wrapper for TileUpdateRootModel with transparent property access."""

    def __getattr__(self, name: str):
        """Provide transparent access to root properties."""
        if hasattr(self.root, name):
            return getattr(self.root, name)
        raise AttributeError(f"'TileUpdate' object has no attribute '{name}'")
...
class (
    
):
    """Enhanced wrapper for  with transparent property access."""
    ...
    def __getattr__(self, name: str):
        ...
        raise AttributeError(
            f"'' object has no attribute '{name}'"
        )
...
class (
    
):
    """Enhanced wrapper for  with transparent property access."""
    ...
    def __getattr__(self, name: str):
        ...
        if hasattr(self.root, name):
            return getattr(self.root, name)
        raise AttributeError(
            f"'' object has no attribute '{name}'"
        )
