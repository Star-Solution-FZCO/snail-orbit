...
class OwnedOption(BaseModel):
    ...
    owner: UserLinkField | None = Field(
        default=None, description='User who owns this option'
    )
    color: str | None = Field(
        default=None, description='Color associated with the option'
    )
    is_archived: bool = Field(
        default=False, description='Whether the option is archived'
    )
...
class OwnedCustomField(CustomField):
    ...
    default_value: OwnedOption | None = Field(
        default=None, description='Default option value'
    )
...
class OwnedMultiCustomField(CustomField):
    ...
    default_value: list[OwnedOption] | None = Field(
        default=None, description='Default option values'
    )
